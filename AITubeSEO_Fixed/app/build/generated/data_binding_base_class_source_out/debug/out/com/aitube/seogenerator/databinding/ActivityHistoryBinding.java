...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialButton btnClearHistory, @NonNull RecyclerView recyclerHistory,
      @NonNull Toolbar toolbar, @NonNull LinearLayout tvEmpty) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((CoordinatorLayout) rootView, btnClearHistory,
